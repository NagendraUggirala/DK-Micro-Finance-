                    ...
                    <div className="p-6">
                      ...
                      <div className="flex justify-between items-center mb-4">
                        ...
                        <div className="text-right">
                          ...
                          <div className="font-semibold text-blue-700">{project.units}</div>
                        </div>
                      </div>
        ...
        {selectedProject && (
          ...
          >
            ...
            >
              ...
              {/* Modal Content */}
              <div className="p-8">
                <h2 className="text-3xl font-bold text-blue-700 mb-4">{selectedProject.title}</h2>
                ...
                {selectedProject.nearby && (
                  <div className="mb-8">
                    <h3 className="text-xl font-semibold text-blue-700 mb-4">Nearby Famous Areas</h3>
                ...
                <div className="mb-8">
                  <h3 className="text-xl font-semibold text-blue-700 mb-4">Plot Features</h3>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                ...
                {selectedProject.amenities && (
                  <div className="mb-8">
                    <h3 className="text-xl font-semibold text-blue-700 mb-4">Amenities</h3>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                ...
                {selectedProject.highlights && (
                  <div className="mb-8">
                    <h3 className="text-xl font-semibold text-blue-700 mb-4">Key Highlights</h3>
