...
const Loans = () => {
      ...
      <section className="relative py-12 md:py-20 bg-gradient-to-r from-slate-800 to-emerald-800 text-white overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-5xl mx-auto text-center">
            ...
            >
              Our <span className="text-amber-400">Loan Products</span>
            </motion.h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                to="/apply"
                className="bg-emerald-600 hover:bg-emerald-700 text-white px-8 py-3 rounded-xl font-bold transition-all duration-300 hover:scale-105 shadow-lg"
              >
                Apply Now
              </Link>
              <Link
                to="/contact"
                className="border-2 border-white text-white hover:bg-white hover:text-slate-800 px-8 py-3 rounded-xl font-bold transition-all duration-300"
              >
                Talk to Expert
              </Link>
            </div>
              ...
              <div className="bg-white rounded-2xl shadow-xl sticky top-24 overflow-hidden">
                <div className="bg-gradient-to-r from-emerald-600 to-teal-600 p-4 text-white">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="bg-white text-emerald-800 px-2 py-1 rounded-full text-xs font-bold">
                ...
                <div className="p-4 bg-gray-50 border-t border-gray-200">
                  <Link
                    to="/apply"
                    className="block w-full bg-gradient-to-r from-emerald-600 to-teal-600 text-white py-2.5 px-4 rounded-xl font-bold text-center hover:shadow-lg transition-all duration-300 text-sm mb-2"
                  >
                    Apply for Loan
                  </Link>
                  <Link
                    to="/contact"
                    className="block w-full bg-slate-200 hover:bg-slate-300 text-slate-800 py-2.5 px-4 rounded-xl font-bold text-center transition-all duration-300 text-sm"
                  >
                    Contact Expert
                  </Link>
                </div>
  ...
  <div className="mt-12">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
      ...
      {/* CTA Section */}
      <section className="py-10 bg-gradient-to-r from-emerald-600 to-teal-600 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-2xl font-bold mb-3">Ready to Apply for a Loan?</h2>
          <p className="text-base text-slate-200 mb-6 max-w-2xl mx-auto">
            Get personalized loan options from our financial experts within 24 hours
          </p>
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <Link
              to="/apply"
              className="bg-white text-emerald-700 hover:bg-slate-50 px-6 py-3 rounded-xl font-bold transition-all duration-300 hover:scale-105 text-sm"
            >
              Apply Online Now
            </Link>
            <Link
              to="/contact"
              className="border-2 border-white text-white hover:bg-white hover:text-slate-800 px-6 py-3 rounded-xl font-bold transition-all duration-300 text-sm"
            >
              Get Expert Advice
            </Link>
          </div>
